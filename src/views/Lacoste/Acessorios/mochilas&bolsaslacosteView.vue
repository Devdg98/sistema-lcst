<template>
    ...
    <h2 class="titulo font-weight-regular text-center mb-2 ">BOLSAS LACOSTE</h2>
    <v-row>
      <v-col cols="12">
        <v-toolbar class="toolbar mb-2" flat color="white">
...
const produtosFiltrados = computed(() => {
  return catalogo.produtos.filter(produto => {
    const categoriaMatch = produto.categoriaProduto === 'Mochilas & Bolsas';
