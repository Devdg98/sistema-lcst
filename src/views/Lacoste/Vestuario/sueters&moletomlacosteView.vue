<template>
  ...
  <h2 class="titulo text-center mb-2 ">MOLETONS LACOSTE</h2>
...
<v-card-subtitle class="subtituloCor pa-0">Todas as Cores(2)</v-card-subtitle>      </v-col>          
<v-col
  ...
  cols="6"
                    ...
                    >
                      <v-card
                        width="190"
                        height="170"
                        class="rounded-0 pa-0 border mt-n4"
                        :elevation="model === cor ? 4 : 1"
                        @click="selectCor(cor)"
                      >
                        <div
...
<v-card-subtitle class="subtituloTamanho pa-0">Todas os Tamanhos</v-card-subtitle>
</v-col>  
          <!-- Tamanhos -->
<v-col
        class="pa-2"
