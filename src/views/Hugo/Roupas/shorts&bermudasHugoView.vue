<template>
    ...
    <h2 class="titulo text-center mb-2">BERMUDA HUGOBOSS</h2>
 <v-toolbar class="toolbar" color="white">
      <v-bottom-sheet v-model="filtrosAtivos">
        ...
        <v-sheet class="pa-4 rounded-0" elevation="0">
          ...
          <div class="mb-4">
            <p color="#002D18" class="text-caption font-weight-medium mb-2">
              CLASSIFICAR POR
            </p>
...
const produtosFiltrados = computed(() => {
  return catalogo.produtos.filter(produto => {
    const categoriaMatch = produto.categoriaProduto === 'Calças & Bermudas';
